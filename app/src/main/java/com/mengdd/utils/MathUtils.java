...
public class MathUtils {
     ...
     * meters.
     *
     * @param origiLocation the location as original point
     * @param destLocation  the location as destination
     * @return
     */
     ...
     * z+(latitude)
     *
     * @param x store longitude distance in x
     * @param z store latitude distance in z
