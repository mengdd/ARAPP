 ...
 */
public class StatusesAPI extends SinaWeiboAPI {
     ...
     * @param listener
     */
    public static void publicTimeline(int count, int page, boolean base_app,
     ...
     * @param listener
     */
    public static void friendsTimeline(int count, int page, boolean base_app,
     ...
     * @param listener
     */
    public static void friendsTimeline(long since_id, long max_id, int count,
     ...
     * @param listener
     */
    public static void friendsTimelineIds(long since_id, long max_id,
     ...
     * @param listener
     */
    public static void homeTimeline(long since_id, long max_id, int count,
                                    int page, boolean base_app, FEATURE feature, boolean trim_user,
                                    RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("since_id", since_id);
     ...
     * @param listener
     */
    public static void userTimeline(long uid, long since_id, long max_id,
                                    int count, int page, boolean base_app, FEATURE feature,
     ...
     * @param listener
     */
    public static void userTimeline(String screen_name, long since_id,
     ...
     * @param listener
     */
    public static void userTimeline(long since_id, long max_id, int count,
                                    int page, boolean base_app, FEATURE feature, boolean trim_user,
                                    RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("since_id", since_id);
     ...
     * @param listener
     */
    public static void userTimelineIds(long uid, long since_id, long max_id,
                                       int count, int page, boolean base_app, FEATURE feature,
                                       RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("uid", uid);
     ...
     * @param listener
     */
    public static void userTimelineIds(String screen_name, long since_id,
                                       long max_id, int count, int page, boolean base_app,
                                       FEATURE feature, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("screen_name", screen_name);
     ...
     * @param listener
     */
    public static void repostTimeline(long id, long since_id, long max_id,
     ...
     * @param listener
     */
    public static void repostTimelineIds(long id, long since_id, long max_id,
                                         int count, int page, AUTHOR_FILTER filter_by_author,
                                         RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("id", id);
     ...
     * @param listener
     */
    public static void mentions(long since_id, long max_id, int count,
                                int page, AUTHOR_FILTER filter_by_author,
                                SRC_FILTER filter_by_source, TYPE_FILTER filter_by_type,
                                boolean trim_user, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("since_id", since_id);
        params.add("max_id", max_id);
     ...
     * @param listener
     */
    public static void mentionsIds(long since_id, long max_id, int count,
                                   int page, AUTHOR_FILTER filter_by_author,
                                   SRC_FILTER filter_by_source, TYPE_FILTER filter_by_type,
                                   RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
     ...
     * @param listener
     */
    public static void bilateralTimeline(long since_id, long max_id, int count,
                                         int page, boolean base_app, FEATURE feature, boolean trim_user,
                                         RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("since_id", since_id);
     ...
     * @param listener
     */
    public static void queryMID(long[] ids, TYPE type, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        if (1 == ids.length) {
            params.add("id", ids[0]);
        } else {
     ...
     * @param listener
     */
    public static void queryID(String[] mids, TYPE type, boolean inbox,
     ...
     * @param listener
     */
    public static void count(String[] ids, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        StringBuilder strb = new StringBuilder();
        for (String id : ids) {
            strb.append(id).append(",");
     ...
     * @param listener
     */
    public static void repost(long id, String status, COMMENTS_TYPE is_comment,
                              RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("id", id);
     ...
     * @param listener
     */
    public static void destroy(long id, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("id", id);
     ...
     * @param listener
     */
    public static void update(String content, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
     ...
     * @param listener
     */
    public static void update(String content, String lat, String lon,
                              RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("status", content);
     ...
     * @param listener
     */
    public static void upload(String content, String file, String lat,
     ...
     * @param pic_id   已经上传的图片pid，多个时使用英文半角逗号符分隔，最多不超过九张。 imageUrl 和
     *                 pic_id必选一个，两个参数都存在时，取picid参数的值为准。
     * @param lat      纬度，有效范围：-90.0到+90.0，+表示北纬，默认为0.0。
     * @param lon      经度，有效范围：-180.0到+180.0，+表示东经，默认为0.0。
     * @param listener
     */
    public static void uploadUrlText(String status, String imageUrl,
                                     String pic_id, String lat, String lon, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("status", status);
     ...
     * @param listener
     */
    public static void emotions(EMOTION_TYPE type, LANGUAGE language,
                                RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
