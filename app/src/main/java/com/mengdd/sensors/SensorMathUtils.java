...
public class SensorMathUtils {
     ...
     * device pitch angle
     *
     * @param R                 the Rotation Mathix in device coordinates
     * @param outR              the Roation Mathix in the remaped world coordinates
     * @param screenRotation    the screen display orientation, including
     *                          ROTATION_0,ROTATION_90,ROTATION_180,ROTATION_270
     * @param devicePitch       the device pitch angle according to the device self axis
     * @param parallelTolerance the devicePitch in this bounds should be considered parallel
     *                          to the ground
     */
    public static void remapCoordinates(float[] R, float[] outR,
     ...
     *
     * @param rotationMatrix the rotation matrix after proper remap coordinates
