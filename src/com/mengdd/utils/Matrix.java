...
public class Matrix {
    ...
    public synchronized void get(float[] array) {
        if (array == null || array.length != 9)
            throw new IllegalArgumentException(
                    "get() array must be non-NULL and size of 9");
    ...
    public void toAt(Vector cam, Vector obj) {
        ...
        set(rightArray[0], rightArray[1], rightArray[2], upArray[0],
                upArray[1], upArray[2], dirArray[0], dirArray[1], dirArray[2]);
    }
    ...
    public synchronized float det() {
        return (this.a1 * this.b2 * this.c3) - (this.a1 * this.b3 * this.c2)
                - (this.a2 * this.b1 * this.c3) + (this.a2 * this.b3 * this.c1)
