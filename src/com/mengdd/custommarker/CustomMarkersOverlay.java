...
public class CustomMarkersOverlay
{
	...
	public void initNewMarker()
	{
		...
		MarkerItem newItem = new MarkerItem(geoPoint, title, snippet,R.drawable.icon_gcoding,R.drawable.nav_turn_via_1);
	...
	public boolean saveMarkerItemToDb()
	{
		boolean success = false;

		success = mMyOverlay.saveMarkerToDb();
		return success;
