 ...
 * It has many methods to get and parse data from numerous web sources.
 * 
...
public abstract class NetworkDataSource extends DataSource
{
	...
	public List<BasicMarker> parse(String url)
	{
		...
		if (null == stream)
		{
			throw new NullPointerException("Get InputScream from HttpUtils.getInputStream(url) but get null! ");
		}
		...
		if (null==string)
		{
			throw new NullPointerException("FileUtils.getInputScreamString return null!");
		}
