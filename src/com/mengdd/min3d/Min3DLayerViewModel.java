...
//		mScene.backgroundColor().setAll(0x00000000);//set the background color to transparent 
		IParser parser = Parser.createParser(Parser.Type.OBJ, mActivity.getResources(),
				"com.mengdd.arapp:raw/cube1", false);
